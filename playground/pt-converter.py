...
INPUT_DIR = "/storage/team/EgoTracksFull/v2/yolo-world-hooks/yolo_gt_embeddings"

# Directory where you want the NEW converted files to be saved
OUTPUT_DIR = "/storage/team/EgoTracksFull/v2/yolo-world-hooks/data/yolo_gt_converted"
